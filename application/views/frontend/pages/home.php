      ...
      <div class="header_section">
         <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               <a class="navbar-brand"href="<?=base_url();?>assets/frontend/index.html"><img src="<?=base_url();?>assets/frontend/images/logo.png"></a>
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav ml-auto">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="<?=base_url();?>assets/frontend/coffees.html">Coffees</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="<?=base_url();?>assets/frontend/shop.html">Shop</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="<?=base_url();?>assets/frontend/blog.html">Blog</a>
                     </li>
                     <li class="nav-item">
               ...
               <div id="banner_slider" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                     <div class="carousel-item active">
                        <div class="row">
                           <div class="col-md-6">
                              <div class="banner_img"><img src="<?=base_url();?>assets/frontend/images/banner-img.png"></div>
                           </div>
                           <div class="col-md-6">
      ...
      <div class="coffee_section layout_padding">
         <div class="container">
            <div class="row">
               ...
               <div class="bulit_icon"><img src="<?=base_url();?>assets/frontend/images/bulit-icon.png"></div>
            </div>
         </div>
                     ...
                     <div class="container-fluid">
                        <div class="row">
                           <div class="col-lg-3 col-md-6">
                              <div class="coffee_img"><img src="<?=base_url();?>assets/frontend/images/img-1.png"></div>
                              <h3 class="types_text">TYPES OF COFFEE</h3>
                              <p class="looking_text">looking at its layout. The point of</p>
                              <div class="read_bt"><a href="#">Read More</a></div>
                           </div>
                           <div class="col-lg-3 col-md-6">
                              <div class="coffee_img"><img src="<?=base_url();?>assets/frontend/images/img-2.png"></div>
                              <h3 class="types_text">BEAN VARIETIES</h3>
                              <p class="looking_text">looking at its layout. The point of</p>
                              <div class="read_bt"><a href="#">Read More</a></div>
                           </div>
                           <div class="col-lg-3 col-md-6">
                              <div class="coffee_img"><img src="<?=base_url();?>assets/frontend/images/img-3.png"></div>
                              <h3 class="types_text">COFFEE & PASTRY</h3>
                              <p class="looking_text">looking at its layout. The point of</p>
                              <div class="read_bt"><a href="#">Read More</a></div>
                           </div>
                           <div class="col-lg-3 col-md-6">
                              <div class="coffee_img"><img src="<?=base_url();?>assets/frontend/images/img-4.png"></div>
      ...
      <div class="about_section layout_padding">
         <div class="container">
            ...
            <div class="about_section_2 layout_padding">
               <div class="image_iman"><img src="<?=base_url();?>assets/frontend/images/about-img.png" class="about_img"></div>
            ...
            <div class="client_section_2">
               <div class="client_taital_main">
                  <div class="client_left">
                     <div class="client_img"><img src="<?=base_url();?>assets/frontend/images/client-img1.png"></div>
                  </div>
               ...
               <div class="client_taital_main">
                  <div class="client_left">
                     <div class="client_img"><img src="<?=base_url();?>assets/frontend/images/client-img2.png"></div>
                  </div>
                  <div class="client_right">
               ...
               <div class="client_taital_main">
                  <div class="client_left">
                     <div class="client_img"><img src="<?=base_url();?>assets/frontend/images/client-img3.png"></div>
                  </div>
                  <div class="client_right">
         ...
         <div class="container">
            ...
            <div class="blog_section_2">
               <div class="row">
                  <div class="col-md-6">
                     <div class="blog_box">
                        <div class="blog_img"><img src="<?=base_url();?>assets/frontend/images/blog-img1.png"></div>
                  ...
                  <div class="col-md-6">
                     <div class="blog_box">
                        <div class="blog_img"><img src="<?=base_url();?>assets/frontend/images/blog-img2.png"></div>
                        <h4 class="date_text">05 April</h4>
                        <h4 class="prep_text">PREP TECHNIQUES Coffee</h4>
                        <p class="lorem_text">distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a moredistracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more</p>
                     </div>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group">
                     ...
                     <div class="subscribe_bt"><a href="#"><img src="<?=base_url();?>assets/frontend/images/teligram-icon.png"></a></div>
                  </div>
               </div>
            </div>
         </div>
